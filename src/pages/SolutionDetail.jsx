...
export default function SolutionDetail() {
  ...
  const solutions = {
    residential: {
      ...
      subtitle: 'Finance for residential properties',
      color: 'from-blue-500 to-blue-600',
      overview: 'Whether you\'re buying your first residential property, upgrading, or accessing equity in your existing property, we facilitate introductions and structured submissions to suitable funders. We work with multiple funders to identify options that suit your circumstances.',
      suitableFor: [
        'First-time buyers looking to purchase a residential property',
        'Existing property owners wanting to refinance',
      ...
      process: [
        ...
        'Support through the assessment and final decision',
      ],
      considerations: [
        'Outcomes depend on assessment and the final decision by funders',
